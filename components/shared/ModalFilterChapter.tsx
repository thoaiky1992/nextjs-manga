...
const ModalFilterChapter: FC<ModalFilterChapterProps> = ({
  ...
  useEffect(() => {
    setTimeout(() => {
      document
        .querySelector(
          `.modal-chapter-list div[data-id="${currentChapterHref}"]`
        )
  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-app min-w-[400px] lg:w-[600px] max-w-[600px] h-[500px] animate-scale absolute z-50 rounded-lg p-5 mx-3">
          <div className="w-full flex items-start justify-between">
            <input
              type="number"
              className="bg-secondary ml-2 py-2 pl-3  pr-5 rounded-lg w-[120px] lg:w-auto text-[10px] lg:text-sm mr-2 cursor-pointer focus:ring-1 focus:ring-primary focus:outline-none"
          ...
          <div
            ref={chapterList}
            className="w-full modal-chapter-list max-h-[400px] mt-5 overflow-y-scroll bg-app flex flex-col px-2"
          >
            {chapters
              .filter(
                (chapter) =>
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      className={`
                    flex w-full rounded-lg my-2 bg-secondary px-4 py-3 items-center justify-between cursor-pointer
